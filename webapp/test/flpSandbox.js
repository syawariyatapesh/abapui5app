		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ABAP Env Application",
									"targetURL": "#adaptabapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"adaptabapui5-display": {
								"semanticObject": "adaptabapui5",
								"action": "display",
								"description": "A Fiori application based on ABAP ENV",
								"title": "ABAP Env Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=adaptabapui5",
									"url": sap.ui.require.toUrl("adaptabapui5")
								}
							}
						}
					}
